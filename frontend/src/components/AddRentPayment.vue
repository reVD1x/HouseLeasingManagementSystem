<template>
  <div class="col-md-8 offset-md-2">
    <h3>登记租金（暂不可用）</h3>
    <p>此功能当前未实现。你可以先在租金列表中点击“登记租金”按钮或返回列表。</p>
    <div class="text-end">
      <router-link to="/rent-payments" class="btn btn-secondary">返回租金列表</router-link>
    </div>
  </div>
</template>

<script setup>
// placeholder component to avoid missing-import error during development
</script>

<style scoped>
.col-md-8 { padding: 1rem }
</style>
<template>
  <div class="col-md-8 offset-md-2">
    <h3>新增租金记录</h3>
